    ...
    <div v-if="!isEmpty" class="mobile-card-list">
      ...
      >
        ...
        <div class="card-body">
          ...
          <p v-if="row.Landmark"><b>Landmark:</b> {{ row.Landmark }}</p>
          <p v-if="row.Distance"><b>Distance:</b> {{ row.Distance }} Km</p>
          <p v-if="row.City"><b>City:</b> {{ row.City }}</p>
          <p v-if="row.Duration"><b>Duration:</b> {{ row.Duration }}</p>
          ...
          <div class="comment-section">
            ...
            <AtomTextarea
              ...
              @changed="$emit('comment-update', row, oldComments, $event)"
            />
          </div>
          ...
          <div class="status-section">
            ...
            <p>
              <b>Next Call: </b>
              <span
                :class="{ 'is-danger': isCallDelayed(row.NextCall) }"
              >
                {{ new Date(row.NextCall).toLocaleDateString('en-GB') }}
              </span>
            </p>
            <AtomDatePicker
          ...
          <div class="latlng-section">
            ...
            <AtomInput
              ...
              @change="$emit('latlng-update', row, $event.target.value)"
            />
          </div>
        </div>
      </div>
