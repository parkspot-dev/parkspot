    ...
    data() {
        return {
            ...
            your mind.",
                ...
                {
                    question:
                        'Does ParkSpot support cashless and no contact bookings ?',
          ...
          <p>\
            ...
            parking space may vary from hourly to monthly basis.',
                ...
                {
                    question:
                        'How to make the payment for booking a parking spot?',
            ...
            they will send you a payment link using which you can make the payment.',
                },
                {
                    ...
                    answer: 'You can go to the My Booking option and can see your booked parking space. There will be a navigation button. You can tap on that button, this will open the Google Maps with the location added on the Map. If the offline booking has been made, then our support team will send the parking location',
                },
            ],
        };
    },
