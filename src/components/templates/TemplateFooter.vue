                        ...
                        <section class="primary-footerContainer">
                              <div class="custom-parkspot">
                                    ...
                                    <AtomParagraph class="pl-4 mb-5">
                                          We provide the cheap and best parking
                                          spot in India. You can't park cheaper!
                                    </AtomParagraph>
                                    <span class="pl-2">
                                          <a
                              ...
                              <div class="contact-info">
                                    ...
                                    <div class="mb-4">
                                          ...
                                          <AtomParagraph :type="'span'">
                                                2nd Floor, Nextcoworks BTM
                                                Layout, BTM 2nd Stage,
            ...
            <section class="secondary-footer">
                  <Wrapper>
                        <section class="secondary-footerContainer">
                              <div>
                                    <AtomParagraph>
                                          © 2021 NeoSpot Pvt Ltd.- ALL RIGHTS
                                          RESERVED
                                    </AtomParagraph>
                                    <AtomParagraph>
                                          <a
