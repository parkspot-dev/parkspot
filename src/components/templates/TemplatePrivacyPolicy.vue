    ...
    <BodyWrapper>
            <div class="privacy-container">
                ...
                <ul class="pl-6" style="list-style-type:disc;">
                    ...
                    <li>
                        <AtomParagraph>
                            <strong>Application</strong>refers to ParkSpot, the software program provided by the Company.
                        </AtomParagraph>
                    </li>
                    <li>
                        <AtomParagraph>
                            <strong>Company</strong>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) 
                            refers to NeoSpot Technologies Pvt Ltd, Kok Rur, Ranchi, Jharkhand.
                        </AtomParagraph>
                    </li>
                    <li>
                        <AtomParagraph>
                    ...
                    <li>
                        <AtomParagraph>
                            <strong>Website</strong>refers to ParkSpot, accessible from https://www.parkspot.in
                        </AtomParagraph>
                    </li>
                    <li>
                        <AtomParagraph class="mb-5">
                ...
                <AtomParagraph :variation="'large'" class="mb-4 mt-4">
                ...
                <ul class="pl-6" style="list-style-type:disc;">
                    <li>
                        <AtomParagraph :variation="'large'" class="mb-4">Necessary / Essential Cookies</AtomParagraph>
                        <AtomParagraph class="mb-4">Type: Session Cookies</AtomParagraph>
                        <AtomParagraph class="mb-4">Administered by: Us</AtomParagraph>
                        <AtomParagraph class="mb-4">
                    ...
                    <li>
                        <AtomParagraph :variation="'large'" class="mb-4">Cookies Policy / Notice Acceptance Cookies</AtomParagraph>
                        <AtomParagraph class="mb-2">Type: Persistent Cookies</AtomParagraph>
                        <AtomParagraph class="mb-2">Administered by: Us</AtomParagraph>
                        <AtomParagraph>
                            Purpose: These Cookies identify if users have accepted the use of cookies on the Website.
                        </AtomParagraph>
                    </li>
                    <li>
                        <AtomParagraph :variation="'large'" class="mb-4">Functionality Cookies</AtomParagraph>
                        <AtomParagraph class="mb-2">Type: Persistent Cookies</AtomParagraph>
                        <AtomParagraph class="mb-2">Administered by: Us</AtomParagraph>
                        <AtomParagraph class="mb-4">
                ...
                <AtomHeading class="mb-5"> Disclosure of Your Personal Data </AtomHeading>
                <AtomParagraph :variation="'large'" class="mb-4">
                ...
                <AtomParagraph :variation="'large'" class="mb-4">
                    ...
                    <ul class="pl-6" style="list-style-type:disc;">
                        <li>
                            <AtomParagraph>
                                By email: connect@parkspot.in
                            </AtomParagraph>
                        </li>
                        <li>
                            <AtomParagraph>
                                By visiting this page on our website: https://www.parkspot.in/contact
                            </AtomParagraph>
                        </li>
                        <li>
                            <AtomParagraph>
                                By phone number: +91-7488239471
                            </AtomParagraph>
                        </li>
                    </ul>              
        </div>
