...
export default {
  ...
  methods: {
    addSite(newSite, index) {
      ...
      this.tenantInfos[index - 1].ParkingStatus.SiteWise = [
        ...this.tenantInfos[index - 1].ParkingStatus.SiteWise,
        newSite,
      ];
    },
    ...
    deleteDetailCard(id, index) {
      ...
      if (check) {
        this.tenantInfos[index - 1].ParkingStatus.SiteWise = this.tenantInfos[
          index - 1
        ].ParkingStatus.SiteWise.filter((tenantInfo) => {
