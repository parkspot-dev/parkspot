...
.wrappermain
  .mainp
    ...
    .content
      ...
      hr
      img(
        src="https://www.stevenvanbelleghem.com/wp-content/uploads/2020/04/Heavy-rains-lash-Delhi-NCR-traffic-snarls-at-many-places.jpg"
      )
      br
      br
      ...
      br
      p.is-size-6.has-text-black.has-text-left
        | send us mail to #[a(href="mailto:connect@parkspot.in") connect@parkspot.in] to join list your parking spots in our platform.
    br
    br
</template>
<script>
