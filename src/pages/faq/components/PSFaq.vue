<template >
  <div class="wrappermain">
    ...
    <div class="mainp">
      ...
      <article class="message">
        <div class="message-header">
          <p>How can your platform help me? How safe is your platform ?</p>
        </div>
        <div class="message-body">
          <p>
      ...
      <article class="message">
        <div class="message-header">
          <p>Does ParkSpot support cashless and no contact bookings ?</p>
        </div>
        <div class="message-body">
          <p>
      ...
      <article class="message">
        ...
        <div class="message-body">
          ...
          <p>
            1) Contact us directly via phone (+91 80929 96057).We will take some
            details from you and your empty space is get listed on our platform.
          </p>
          <p>
            2) Email us at
