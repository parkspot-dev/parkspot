...
describe('Vuex - spot module', () => {
    ...
    it('getSpotDetails commits correct data', async () => {
        const apiResponse = {
            Site: {
                SiteID: 'SITE_1',
                Name: 'Test Spot',
            ...
            User: { Name: 'Owner' },
            Bookings: [{ id: 1 }],
            Account: { UpiID: 'test@upi', PaymentApp: 'GPAY' },
        };
    ...
    it('updateAvailability posts updated site', async () => {
    ...
    it('updateLastCallDate posts updated site', async () => {
    ...
    it('updateRemark updates remark & date', async () => {
        store.state.spot.spotDetails = {};
